...
It explores how modern AI agent systems can interact according to a clearly defined protocol. It is inspired by **Multiparty Session Types (MPST)**, while focusing on declarative session protocols.
